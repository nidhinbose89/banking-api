...
# ECS tasks register themselves here
...
# (proper ACM cert requires a domain; we don't have one for this project)
...
resource "tls_self_signed_cert" "alb" {
  ...
  subject {
    common_name  = "banking-api.local"
    organization = "Banking API Demo"
  }
